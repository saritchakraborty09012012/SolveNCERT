...
export default function TermsPage() {
  return (
    <CompanyLayout title="Terms of Service" description="SolveNCERT Terms of Service." canonical="/terms" breadcrumb="Terms of Service" lastUpdated="May 2026">
      ...
      <p>All original content on SolveNCERT — including solutions written by our team, platform design, and branding — is owned by SolveNCERT and NDe: NoirDemons. NCERT textbooks and their content are the intellectual property of the National Council of Educational Research and Training.</p>
